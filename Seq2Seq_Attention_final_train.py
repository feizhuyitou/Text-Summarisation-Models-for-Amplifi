...
class Encoder(nn.Module):
    ...
    def forward(self, src):
        ...
        # enc_output is stacked [forward_1, backward_1, forward_2, backward_2, ...]
        # enc_hidden are always from the last layer
...
model.load_state_dict(torch.load('Att_Seq_default.pt'))
